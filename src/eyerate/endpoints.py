...
class BaseFinancialSecurityEndpoint(ABC):
    ...
    def _map_security_type(self, yahoo_type: str) -> str:
        mapping = {
            "EQUITY": FinancialSecurityType.STOCK.value,
            "ETF": FinancialSecurityType.ETF.value,
            "MUTUALFUND": FinancialSecurityType.MUTUAL_FUND.value,
            "MONEYMARKET": FinancialSecurityType.MUTUAL_FUND.value,
            "BOND": FinancialSecurityType.BOND.value
        }
        return mapping.get(yahoo_type, FinancialSecurityType.STOCK.value)
...
class YahooScraperEndpoint(BaseFinancialSecurityEndpoint):
    ...
    def get_name(self) -> str:
        return "Matika Standard (Yahoo Scraper)"
